jump 2           // jump to the address 2
lsi &0, -7       // load -7 in ac0 if something goes wrong
jal 4            // link the value 3 in lk and jump to 4
lsi &0, -7
lli &0, 8        // load 8 in ac0
mfac $0, &0      // move 8 to rf0
jr $0            // jump to the address 8 in rf0
lsi &0, -7
lli &1, 12       // load 12 in ac1
mfac $1, &1      // move 12 to rf1
jral $1          // link the value 15 in lk and jump to the address 12 in rf0
lsi &0, -7
